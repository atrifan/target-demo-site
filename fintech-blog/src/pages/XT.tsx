...
const XT: React.FC<XperienceProps> = ({ displayName, token, setToken, activityIndex, setActivityIndex, experienceIndex, setExperienceIndex, trueAudienceId, setTrueAudienceId, country, hobby, age, refreshKey, mcId}) => {
    ...
    <main>
      <div style={{ padding: '20px' }}>
        ...
        <div style={{ marginBottom: '20px' }}>
          <Link
            to={{
              pathname: "/target-demo-site/xt/xp",
              search: new URLSearchParams({
                ...Object.fromEntries(searchParams.entries()), // Keep the existing search params
                at_preview_token: 'xMiDXHfRPwagv9cCrX1PtYsfdKGAJyg5DsJ3XxNj67A',
                at_preview_index: '1_1',
                at_preview_listed_activities_only: 'true'
              }).toString()
            }}
            onClick={() => handleSetToken('xMiDXHfRPwagv9cCrX1PtYsfdKGAJyg5DsJ3XxNj67A', 1, 1)}
        ...
        <div style={{ marginBottom: '20px' }}>
          <Link
            ...
            onClick={() => handleSetToken('xMiDXHfRPwagv9cCrX1PtYsfdKGAJyg5DsJ3XxNj67A', 1, 2)}
            style={{ textDecoration: 'none', color: '#000', fontSize: '18px' }}
          >
            Go to Experience 2
          </Link>
        ...
        <div style={{ marginBottom: '20px' }}>
          <Link
            ...
            onClick={() => handleSetToken('xMiDXHfRPwagv9cCrX1PtYsfdKGAJyg5DsJ3XxNj67A', 1, 3)}
            style={{ textDecoration: 'none', color: '#000', fontSize: '18px' }}
          >
            Go to Experience 3
          </Link>
